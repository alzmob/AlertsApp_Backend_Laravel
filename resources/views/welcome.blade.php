...
<html lang="en">
<head>
    <title>Alerts - Inform. Alert. Secure</title>
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="/landing/plugins/jquery-flipster/dist/jquery.flipster.min.css">
...
{{--                        <img class="logo-icon" src="/landing/images/logo-icon.svg" alt="logo">--}}
                        <span class="logo-text">ALERTS</span></a></h1>
            </nav>
            ...
            <div class="col-12 col-md-6 pt-3 pt-md-4">
                ...
                <div class="cta-btns">
                    ...
                    <ul class="app-stores list-unstyled list-inline mx-auto mx-md-0 d-inline-block">
                        <li class="list-inline-item mr-3"><a href="#"><img class="ios" src="/landing/images/appstore-apple.svg" alt="app-store"></a></li>
                        <li class="list-inline-item"><a href="#"><img class="android" src="/landing/images/appstore-android.svg" alt="google play"></a></li>
                    </ul>
                </div>
            </div>
        </div><!--//row-->
        ...
        <div class="logos-row row mx-auto">
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-1.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-2.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-3.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-4.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-5.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
                <div class="item-inner">
                    <img src="/landing/images/logos/logo-6.svg" alt="logo">
                </div><!--//item-inner-->
            </div><!--//item-->
        ...
        <div class="row">
            <div class="item col-12 col-lg-4">
                <div class="item-inner text-center p-3 p-lg-5">
                    <img class="mb-3" src="/landing/images/icon-target.svg" alt="" />
                    <h5>Focused on UX</h5>
            ...
            <div class="item col-12 col-lg-4">
                <div class="item-inner text-center p-3 p-lg-5">
                    <img class="mb-3" src="/landing/images/icon-rocket.svg" alt="" />
                    <h5>Convert Users</h5>
                    <div>Use this area to list your app's key benefits. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. </div>
                </div><!--//item-inner-->
            </div><!--//item-->
            <div class="item col-12 col-lg-4">
                <div class="item-inner text-center p-3 p-lg-5">
                    <img class="mb-3" src="/landing/images/icon-cogs.svg" alt="" />
    ...
    <div class="container py-lg-5">
        ...
        <div class="row pt-5 mb-5">
            ...
            <div class="col-12 col-md-6 col-xl-5 offset-xl-1 d-none d-md-block">
                <img class="product-figure product-figure-1 img-fluid" src="/landing/images/product-figure-1.png" alt="" />
            </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-xl-5 order-md-2 pr-xl-3 d-none d-md-block">
                <img class="product-figure product-figure-2 img-fluid" src="/landing/images/product-figure-2.png" alt="" />
            </div>
            ...
            <div class="flip-items pb-5">
                <div class="flip-item text-center text-md-left">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media flex-column flex-md-row">
                            <img class="source-profile rounded-circle mr-md-3 mx-auto mx-md-0" src="/landing/images/users/user-1.jpg" alt="" />
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media ">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-2.jpg" alt="" />
                            <div class="source-info media-body pt-3">
                                <div>Helen Owens</div>
                                <div>New York, US</div>
                            </div>
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-3.jpg" alt="" />
                            <div class="source-info media-body pt-3">
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-4.jpg" alt="" />
                            <div class="source-info media-body pt-3">
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-5.jpg" alt="" />
                            <div class="source-info media-body pt-3">
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-6.jpg" alt="" />
                            <div class="source-info media-body pt-3">
                                <div>Tony Cheng</div>
                                <div>San Francisco, US</div>
                            </div>
                ...
                <div class="flip-item">
                    <div class="item-inner shadow-lg rounded">
                        ...
                        <div class="source media">
                            <img class="source-profile rounded-circle mr-3" src="/landing/images/users/user-7.jpg" alt="" />
                            <div class="source-info media-body pt-3">
...
<footer class="footer theme-bg-primary">
    ...
    <div class="footer-bottom text-center pb-5">
        <small class="copyright">Copyright &copy; {{ date('Y') }} <a href="{{ env('APP_URL') }}">{{ env('APP_NAME') }}</a>. All rights reserved.</small>
    </div>
...
<!-- Javascript -->
<script type="text/javascript" src="/landing/plugins/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="/landing/plugins/popper.min.js"></script>
<script type="text/javascript" src="/landing/plugins/bootstrap/js/bootstrap.min.js"></script>

<!-- Page Specific JS -->
<script type="text/javascript" src="/landing/plugins/jquery-flipster/dist/jquery.flipster.min.js"></script>
<script type="text/javascript" src="/landing/js/flipster-custom.js"></script>
